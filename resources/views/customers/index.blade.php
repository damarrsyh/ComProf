...
@section('pages')
            ...
            <div class="card h-100" style="background: var(--bs-gray-200);">
              ...
              <div class="card-body hov px-3">
                ...
                <ul class="list-group list-group-flush pb-3">
                  <li class="list-group-item  bg-primary text-white">{{ $customers->business }}</li>
                ...
                <a class="btn btn-primary hov-1 text-white" data-bs-toggle="modal"
                  data-bs-target="#customerdesc-{{ $index }}">Read More</a>
              </div>
            </div>
          </div>
        @endforeach
  ...
  <!--MODAL-->
  <div class="modal fade" id="customerdesc-{{ $index }}" tabindex="-1" aria-labelledby="ModalLabel1"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title text-light" id="customerdesc-{{ $index }}">{{ $customers->name }} -
            {{ $customers->branch }}</h5>
